...
from PyQt5.QtCore import Qt, QThread, pyqtSignal, QObject, pyqtSignal, QTimer
...
class Window(QtWidgets.QMainWindow):
	...
	def initUI(self):
		...
		self.greeting_text = QtWidgets.QLabel(self)
	...
	def updateInformation(self):
		...
		#Greeting
		_thread.start_new_thread(self.fade_greeting, ("foo", "bar"))
